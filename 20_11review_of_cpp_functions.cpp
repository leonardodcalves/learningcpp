...
Preview: Docs Loading link description
 allow you to create more flexible, modular, and DRY code.
...
A function has a definition (or body) with a group of statements and a 
...
variables
Preview: Docs Loading link description
 used as placeholders for function input values.
...
Instructions
Try using functions to rewrite (or refactor) that IT conversation program we 
showed you.

You can also use this space to play around with building your own functions. 
Have fun!
